...
class Product {
   ...
   *
   * data should be { name, ingredients, calorieCount, category, price, imageUrl1, imageUrl2, imageUrl3 }
   *
   * Returns { name, ingredients, calorieCount, category, price, imageUrl1, imageUrl2, imageUrl3}
   *
  ...
  static async create({
    ...
    const result = await db.query(
      `INSERT INTO products
            ...
            RETURNING id, name, ingredients, calorie_count AS "calorieCount", category, price, image_url1 AS "imageUrl1", image_url2 AS "imageUrl2", image_url3 AS "imageUrl3"`,
      [
        id,
        name,
        ingredients,
  ...
  static async findAll({ name, category } = {}) {
    ...
    // 		"category": "DogFood",
    // 		"price": 275.49,
    // 		"imageUrl1": "/images/DogFood_BeefSalmon.jpg",
    //    "imageUrl1": "/images/Beef&SalmonActualIngredients.jpg",
    //    "imageUrl1": "/images/Beef&SalmonGuaranteedAnalysis.jpg",
    ...
    // 	   "category": "DogFood",
    // 	   "price": 55.49,
    // 	   "imageUrl1": "/images/DogFood_Bison.png",
    //     "imageUrl2": "images/Just_Real_Food.png",
    //     "imagesUrl3": "/images/BisonIngredients&GuaranteedAnalysis_.jpg"
    //   },
    // ]
  }
   ...
   *
   * Returns [{ id, name, ingredients, calorieCount, category, price, weight, imageUrl1, imageUrl2, imageUrl3  }, ...]
   *
   ...
   *
   * Returns [{ id, name, ingredients, calorieCount, category, price, weight, imageUrl }, ...]
   *
   ...
   *
   * Data can include: {name, ingredients, calorieCount, category, price, imageUrl1, imageUrl2, imageUrl3}
   *
   * Returns {id, name, ingredients, calorieCount, category, price, imageUrl1, imageUrl2, imageUrl3}
   *
   * Throws NotFoundError if not found.
   */
  ...
  static async update(name, data) {
    ...
    // set column for WHERE expression. VarIdx: "name" = $6
